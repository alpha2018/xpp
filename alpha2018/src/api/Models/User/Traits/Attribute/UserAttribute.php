<?php namespace App\Models\User\Traits\Attribute;
...
trait UserAttribute
{
    ...
    {
        if ($this->isConfirmed())
            return "<label class='label label-success'>".trans('yes')."</label>";
        return "<label class='label label-danger'>".trans('no')."</label>";
    }
    ...
    public function isActive() {
        return time() - $this->actived_at  > 30*12*60*60;
    }
    ...
    {
        return '<a href="' . route('user.change-password', $this) . '" class="btn btn-xs btn-info"><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="' . trans('buttons.backend.access.users.change_password') . '"></i></a> ';
    }
    ...
    {
        if ($this->getAuthIdentifier() != auth()->user()->getAuthIdentifier()) {
    ...
    {
        return '<a href="' . route($this->pathname.'.restore', $this) . '" name="restore_user" class="btn btn-xs btn-info"><i class="fa fa-refresh" data-toggle="tooltip" data-placement="top" title="' . trans('buttons.backend.access.users.restore_user') . '"></i></a> ';
    }
