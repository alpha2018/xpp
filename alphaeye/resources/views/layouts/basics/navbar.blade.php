...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li>
                <a href="/"><i class="fa fa-dashboard"></i> <span class="nav-label">Dashboards</span> <span class="fa "></span></a>

            </li>
            <li>
                <a href="index.html"><i class="fa fa-users"></i> <span class="nav-label">管理中心</span> <span class="fa arrow"></span></a>
